            ...
            <?php foreach($posts as $post): ?>
              ...
              <div class="news_post_small">
                <div class="row news_post_row">
                  <div class="col_lg-3 col-md-4 col-sx-12">
              ...
              <div class="milestones row">
                <div class="milestone col-md-3 col-lg-3 col-sx-12">
                  <div class="milestone_counter">
                    <p>教授数</p>
                    <img src="<?php get_template_directory_uri(); ?>/images/icon4.png" alt="" />
                ...
                <div class="milestone col-md-3 col-lg-3 col-sx-12">
                  <div class="milestone_counter">
                    <p>学習コース</p>
                    <img src="<?php echo get_template_directory_uri(); ?>/mages/icon2.png" alt="" />
